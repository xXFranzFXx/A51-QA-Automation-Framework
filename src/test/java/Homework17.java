...
public class Homework17 extends BaseTest{
        ...
        public void addSongToPlaylist() throws InterruptedException {
            String expectedSongAddedMessage = "Added 1 song into \"playlist.\"";
        ...
        public void choosePlaylist() throws InterruptedException {
            WebElement playlist = driver.findElement(By.xpath("//section[@id='songResultsWrapper']//li[contains(text(), 'playlist')]"));
            playlist.click();
            Thread.sleep(2000);
        }
